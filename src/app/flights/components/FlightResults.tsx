    ...
    <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden animate-pulse">
      ...
      <div className="flex items-center justify-between px-6 py-4 bg-gray-50 border-b border-gray-100">
        ...
        <div className="flex flex-col items-end gap-1.5">
          <div className="h-9 w-24 bg-amber-100 rounded-xl" />
    ...
    return (
      <div className="w-full max-w-7xl mx-auto">
        <div className="bg-white border border-gray-200 rounded-2xl p-14 text-center shadow-sm">
          ...
          <h3 className="text-base font-bold text-[#171717] mb-1">Something went wrong</h3>
          <p className="text-sm text-gray-400 mb-5">{error}</p>
          <button
            onClick={() => window.location.reload()}
            className="inline-flex items-center gap-2 text-sm font-bold text-amber-600 border border-amber-200 bg-amber-50 px-5 py-2 rounded-xl hover:bg-amber-100 transition-all duration-200"
          >
            Try again
          </button>
        </div>
  ...
  if (!flights.length) {
    return (
      <div className="w-full max-w-7xl mx-auto">
        <div className="bg-white border border-gray-200 rounded-2xl p-14 text-center shadow-sm">
          <p className="text-5xl mb-4 opacity-20">✈</p>
          <h3 className="text-base font-bold text-[#171717] mb-1">No flights found</h3>
